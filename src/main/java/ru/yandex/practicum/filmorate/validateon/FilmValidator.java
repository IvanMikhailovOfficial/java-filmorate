...
public class FilmValidator {
    public static void validate(Film film) {
        if (film.getName().isBlank()) {
            ...
            //throw new ResponseStatusException(HttpStatus.valueOf(400), "Имя фильма не может быть пустым");
        }
        ...
        if (film.getDescription().length() > 200) {
            ...
            //"Длина описания не может превышать 200 симвлов");
        }
        ...
        if (film.getReleaseDate().isBefore(LocalDate.of(1895, 12, 28))) {
            ...
            //throw new ResponseStatusException(HttpStatus.valueOf(400),
            //"Дата создания фильма не может быть до 28 декабря 1895 года");
        }
        ...
        if (film.getDuration() < 0) {
            ...
            //throw new ResponseStatusException(HttpStatus.valueOf(400),
            //"Количество минут не может быть меньше 0");
        }
    }
}
